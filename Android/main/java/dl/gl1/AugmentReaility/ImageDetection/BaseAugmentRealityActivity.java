...
package dl.gl1.AugmentReaility.ImageDetection;
...
public class BaseAugmentRealityActivity extends Activity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        if (!Engine.initialize(this, key)) {
            ...
            Toast.makeText(BaseAugmentRealityActivity.this, Engine.errorMessage(), Toast.LENGTH_LONG).show();
            return;
        }
