...
public class HelloAR {
    ...
    public void initialize() {
        ...
        loadFromImage(tracker, "a.jpg", "a");
        loadFromImage(tracker, "b.jpg", "b");
                    ...
                    if (result != null) {
                        for (TargetInstance targetInstance : result.targetInstances()) {
                            if (targetInstance.status() == TargetStatus.Tracked) {
                                ...
                                Log.d("name", target.name());
                                //target.name().equals("a");
                                boxRenderer.render(projectionMatrix, targetInstance.pose());
                            }
                        }
                        result.dispose();
                    }
