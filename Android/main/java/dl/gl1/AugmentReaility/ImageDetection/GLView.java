...
public class GLView extends GLSurfaceView
{
    ...
    public float startPosX,startPosY,startAngle,startRatio;
    ...
    public boolean onTouchEvent(MotionEvent e){
        switch (e.getAction()) {
            case MotionEvent.ACTION_DOWN:{
                startPosX=e.getX();
                startPosY=e.getY();
                startAngle= BoxRenderer.rotateAngle;
                startRatio=BoxRenderer.scaleValue;
            }
            case MotionEvent.ACTION_MOVE:{
                float dx=e.getX()-startPosX;
                float dy=e.getY()-startPosY;
                BoxRenderer.rotateAngle=startAngle+dx/10;
                BoxRenderer.scaleValue=startRatio+dy/1000;
            }
